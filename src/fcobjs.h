...
FC_OBJECT (SIZE,		FcTypeRange,	FcCompareRange,	NULL)
...
FC_OBJECT (FONT_VARIATIONS,	FcTypeString,	NULL,		NULL)
FC_OBJECT (VARIABLE,		FcTypeBool,	FcCompareBool,	NULL)
FC_OBJECT (FONT_HAS_HINT,	FcTypeBool,	FcCompareBool,  NULL)
